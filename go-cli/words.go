...
func registerSDKWords(r *eng.Registry, client *sdk.ChecklyhqSDK) {
...
func runOp(client *sdk.ChecklyhqSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
