# Checklyhq SDK primary utility test
...
from projectname_sdk import ChecklyhqSDK
from projectname_sdk.core.spec import ChecklyhqSpec
from projectname_sdk.core.result import ChecklyhqResult
from projectname_sdk.core.response import ChecklyhqResponse
from projectname_sdk.core.operation import ChecklyhqOperation
from projectname_sdk.core.error import ChecklyhqError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ChecklyhqBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ChecklyhqError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ChecklyhqSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ChecklyhqSDK.test(None, None)
        ...
        class TestInitFeature(ChecklyhqBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ChecklyhqBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ChecklyhqSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ChecklyhqSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ChecklyhqSDK.test(None, setup_opts)
