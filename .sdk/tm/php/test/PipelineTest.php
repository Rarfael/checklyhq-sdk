...
{
    private static function utility(): ChecklyhqUtility
    {
        return new ChecklyhqUtility();
    }
    ...
    private static function ctx(array $over = []): ChecklyhqContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ChecklyhqContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ChecklyhqOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ChecklyhqError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ChecklyhqOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ChecklyhqMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ChecklyhqOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ChecklyhqMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ChecklyhqOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ChecklyhqMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChecklyhqSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ChecklyhqMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ChecklyhqResponse([]),
            'result' => new ChecklyhqResult([]),
        ]);
        [, $err] = ChecklyhqMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ChecklyhqSpec([]),
            'response' => null,
            'result' => new ChecklyhqResult([]),
        ]);
        [, $err] = ChecklyhqMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ChecklyhqSpec(['step' => 's']),
            'response' => new ChecklyhqResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ChecklyhqResult([]),
        ]);
        [, $err] = ChecklyhqMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ChecklyhqSpec(['step' => 's']),
            'response' => new ChecklyhqResponse(self::resp(200, ['v' => 1])),
            'result' => new ChecklyhqResult([]),
        ]);
        [, $err] = ChecklyhqMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ChecklyhqSpec(['step' => 's']),
            'response' => new ChecklyhqResponse(self::resp(200, ['v' => 2])),
            'result' => new ChecklyhqResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ChecklyhqMakeResponse::call($ctx);
    ...
    {
        $preset = new ChecklyhqResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ChecklyhqSpec([]),
            'response' => new ChecklyhqResponse([]),
            'result' => new ChecklyhqResult([]),
        ...
        [$got, $err] = ChecklyhqMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ChecklyhqResult([])]);
        [, $err] = ChecklyhqMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ChecklyhqSpec([]), 'result' => null]);
        [, $err] = ChecklyhqMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChecklyhqSpec(['step' => 's']),
            'result' => new ChecklyhqResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ChecklyhqOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChecklyhqMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ChecklyhqSpec(['step' => 's']),
            'result' => new ChecklyhqResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ChecklyhqOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ChecklyhqMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ChecklyhqResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ChecklyhqSpec([]),
            'result' => new ChecklyhqResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ChecklyhqMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChecklyhqMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ChecklyhqError('boom', 'boom');
        $utility->fetcher = function (ChecklyhqContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChecklyhqSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ChecklyhqMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ChecklyhqContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ChecklyhqMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ChecklyhqResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ChecklyhqContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ChecklyhqSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ChecklyhqMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ChecklyhqResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ChecklyhqSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ChecklyhqMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ChecklyhqMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ChecklyhqMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ChecklyhqResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ChecklyhqDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ChecklyhqResult(['ok' => false])]);
        $this->expectException(ChecklyhqError::class);
        ChecklyhqDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ChecklyhqResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ChecklyhqMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ChecklyhqMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ChecklyhqBaseFeature();
        $b = new ChecklyhqBaseFeature();
        ChecklyhqFeatureAdd::call($ctx, $a);
        ChecklyhqFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ChecklyhqBaseFeature
    {
        $f = new ChecklyhqBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ChecklyhqFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ChecklyhqContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ChecklyhqSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ChecklyhqPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ChecklyhqResponse(['headers' => null]),
            'result' => new ChecklyhqResult([]),
        ]);
        ChecklyhqResultHeaders::call($ctx);
