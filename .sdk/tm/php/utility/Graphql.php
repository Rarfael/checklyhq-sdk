...
class ChecklyhqGraphql
{
    ...
    // equivalent.
    public static function body(ChecklyhqContext $ctx): mixed
    {
    ...
    public static function errors(ChecklyhqContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
