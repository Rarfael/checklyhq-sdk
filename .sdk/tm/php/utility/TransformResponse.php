...
// Checklyhq SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ChecklyhqTransformResponse
{
    public static function call(ChecklyhqContext $ctx): mixed
    {
        ...
        $transform = ChecklyhqHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
