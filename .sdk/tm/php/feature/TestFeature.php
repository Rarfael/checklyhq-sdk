...
// Checklyhq SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ChecklyhqTestFeature extends ChecklyhqBaseFeature
{
    ...
    public function init(ChecklyhqContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ChecklyhqContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = ChecklyhqParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ChecklyhqContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ChecklyhqContext $ctx, $op, $args): array
    {
