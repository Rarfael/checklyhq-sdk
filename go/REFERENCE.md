# Checklyhq Golang SDK Reference

Complete API reference for the Checklyhq Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ChecklyhqSDK`
...
#### `Check(data map[string]any) ChecklyhqEntity`
