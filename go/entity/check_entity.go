...
func NewCheckEntity(client *core.ChecklyhqSDK, entopts map[string]any) *CheckEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CheckEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CheckUpdateData and returns an Check. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CheckEntity) UpdateTyped(reqdata CheckUpdateData, ctrl map[string]any) (Check, error) {
...
func (e *CheckEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CheckRemoveMatch and returns an Check. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CheckEntity) RemoveTyped(reqmatch CheckRemoveMatch, ctrl map[string]any) (Check, error) {
