...
func registerTools(server *mcp.Server, client *sdk.ChecklyhqSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "checklyhq_list",
		Description: "List records from Checklyhq. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "checklyhq_load",
		Description: "Load a single record from Checklyhq. " +
...
func runOp(client *sdk.ChecklyhqSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ChecklyhqSDK, name string) (sdk.ChecklyhqEntity, error) {
