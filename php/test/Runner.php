...
class ChecklyhqTestRunner
{
    ...
    {
        $live = self::getenv('CHECKLYHQ_TEST_LIVE');
        $override = self::getenv('CHECKLYHQ_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CHECKLYHQ_TEST_EXPLAIN');
...
class_alias('ChecklyhqTestRunner', 'Runner');
class_alias('ChecklyhqHelpers', 'Helpers');
