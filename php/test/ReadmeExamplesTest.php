...
// Checklyhq SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ChecklyhqSDK::test)
...
{
    private const SDK_CLASS = 'ChecklyhqSDK';
    ...
    private const SDK_BASE = 'checklyhq_sdk';
