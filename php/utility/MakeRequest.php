...
// Checklyhq SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ChecklyhqMakeRequest
{
    public static function call(ChecklyhqContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ChecklyhqResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ChecklyhqResponse($fetched);
        } else {
