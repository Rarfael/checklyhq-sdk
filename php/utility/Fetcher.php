...
// Checklyhq SDK utility: fetcher

class ChecklyhqFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ChecklyhqSDK/1.0)';
    ...
    public static function call(ChecklyhqContext $ctx, string $fullurl, array $fetchdef): array
    {
