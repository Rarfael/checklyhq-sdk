...
from checklyhq_sdk.core.control import ChecklyhqControl
...
from checklyhq_sdk.core.helpers import get_ctx_prop, to_map
...
class ChecklyhqContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ChecklyhqSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ChecklyhqResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ChecklyhqResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ChecklyhqError(code, msg, self)
