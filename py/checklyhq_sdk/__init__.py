...
from checklyhq_sdk.utility import register

# Load features
from checklyhq_sdk.feature.base_feature import ChecklyhqBaseFeature
from checklyhq_sdk.features import _has_feature, _make_feature
...
class ChecklyhqSDK:
    ...
    def get_utility(self):
        return ChecklyhqUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ChecklyhqSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Check(self, data=None) -> "CheckEntity":
        ...
        from checklyhq_sdk.entity.check_entity import CheckEntity
        return CheckEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ChecklyhqSDK":
        if sdkopts is None:
            sdkopts = {}
