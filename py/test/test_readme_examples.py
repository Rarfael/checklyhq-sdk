# Checklyhq SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ChecklyhqSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ChecklyhqSDK(...) and ChecklyhqSDK.test(...) become
#      ChecklyhqSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "checklyhq_sdk"
_SDK_CLASS = "ChecklyhqSDK"
