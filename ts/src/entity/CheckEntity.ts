...
class CheckEntity extends ChecklyhqEntityBase<Check> {
  ...
  async update(this: any, reqdata?: CheckUpdateData, ctrl?: Control): Promise<CheckEntity> {
  ...
  async remove(
    this: any, reqmatch?: CheckRemoveMatch, ctrl?: Control,
  ): Promise<CheckEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CheckEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
