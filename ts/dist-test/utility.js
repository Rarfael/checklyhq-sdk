...
function envOverride(m) {
    if ('TRUE' === process.env.CHECKLYHQ_TEST_LIVE ||
        'TRUE' === process.env.CHECKLYHQ_TEST_OVERRIDE) {
    ...
    m.CHECKLYHQ_TEST_EXPLAIN = process.env.CHECKLYHQ_TEST_EXPLAIN || m.CHECKLYHQ_TEST_EXPLAIN;
    return m;
}
